...
function AttemptPaper() {
  ...
  const {
    token, setToken, isExamStarted, setIsExamStarted,
  ...
  useEffect(
    () => {
      if (exam_ended == false) { startTimer(); }
      return () => {
        clearInterval(interval);
      };
    },
      ...
      { isLoading
        ...
        : (
          <div>
            ...
            !isStarted
              ? <></>
              : <button onClick={EndExam} className="genric-btn danger-border circle">End Exam</button>
            }
            </div>
            <h1 align="center">
              Paper -
            ...
            !isStarted
              ? (
                <div align="center">
                  <button onClick={StartExam} className="genric-btn success-border circle">Start Exam</button>
                </div>
              )
              : <></>
            }
                                         ...
                                         <div className="switch-wrap d-flex justify-content-between">
                                           ...
                                           <div className="primary-checkox">
                                             <input
                                               ...
                                               onChange={(e) => {
                                                 if (answer != option) { setAnswer(option); } else {
                                                   setAnswer('');
                                                 }
                                               }}
                                             />
                              ...
                              <div className="container box_1170 border-top-generic">
                                {
                                                      Number(question_no) !== 1
                                                        ? <button onClick={AnotherQuestion} value={Number(question_no) - 1} className="genric-btn primary-border">Prev</button>
                                                        : <></>
                                                    }
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                {Number(question_no) !== totalQns
                                  ? <button onClick={AnotherQuestion} value={Number(question_no) + 1} className="genric-btn primary-border">Next</button>
                                  : <></>}
